...
data class AlarmItem(val id: Long, var time: String, var selectedDays: List<String>, var isChecked: Boolean ,
                     var puzzleType: String? , var seekBarDifficulty: String?, var repetitions: Int? , var shakeRepetitions: Int? ,
                     var selectedSentence: String? , var selectedRingtone: String? ){
